...
<html lang="en">
  ...
  <body class="light-only">
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Despachos
                      <!-- &nbsp;<a href="nuevodespacho.php"><img src="img/icon_alta.png" width="24" height="25" border="0" alt="Nuevo despacho" title="Nuevo despacho"></a>
                      &nbsp;<a href="listardespachosAnuladas.php"><img src="img/canceled.png" width="24" height="25" border="0" alt="despachos Eliminados" title="despachos Eliminados"></a> -->
                      <!-- &nbsp;<a href="exportdespachos.php"><img src="img/xls.png" width="24" height="25" border="0" alt="Exportar despachos" title="Exportar despachos"></a> -->
                    </h5>
                  </div>
                  <div class="card-body">
                  <div class="row">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a id="btnEliminarDespacho" class="btn btn-primary">Eliminar</a>
          </div>
        </div>
      </div>
    </div>
    ...
    function openModalEliminardespacho(idDespacho){
      $('#eliminarModal').modal("show");
      document.getElementById("btnEliminarDespacho").href="anularDespacho.php?id="+idDespacho;
    }

		$(document).ready(function() {

      getdespachos();
      $(".filtraTabla").on("change",getdespachos);
    ...
    function getdespachos(){
      ...
      table.DataTable({
        ...
        serverSide: true,
        processing: true,
        ajax:{url:'ajaxListarDespachos.php?desde='+desde+'&hasta='+hasta+'&id_cliente='+id_cliente},
				stateSave: true,
				responsive: true,
				language: {
          "decimal": "",
        ...
        "columns":[
          ...
          {render: function(data, type, row, meta) {
            ...
            if(row.facturacion=="Sin factura"){
              ...
              btnAnular='<a href="#" title="Eliminar" onclick="openModalEliminarDespacho('+row.id_despacho+')"><img src="img/icon_baja.png" width="24" height="25" border="0" alt="Eliminar"></a>&nbsp;&nbsp;'
            }
            return btnVer+btnImprimir+btnAnular;
          }},
          // {
          //   "data": "detalle_despachos",
