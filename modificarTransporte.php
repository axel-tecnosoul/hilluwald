<?php
	...
	if ( !empty($_POST)) {
		...
		$pdo = Database::connect();
		$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		$sql = "SELECT id, nombre, tipo, patente, id_usuario FROM transportes WHERE id = ? ";
		$q = $pdo->prepare($sql);
		$q->execute(array($id));
                      ...
                      <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group row">
								...
								<div class="col-sm-9"><input name="tipo" type="text" maxlength="99" class="form-control" value="<?php echo $data['tipo']; ?>" required="required"></div>
							</div>
                            <div class="form-group row">
