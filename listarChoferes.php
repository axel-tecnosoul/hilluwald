                ...
                <div class="col-10">
                  <div class="page-header-left">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">Choferes</li>
                    </ol>
                  </div>
                </div>
                <!-- Bookmark Start-->
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Choferes&nbsp;<a href="nuevoChofer.php"><img src="img/icon_alta.png" width="24" height="25" border="0" alt="Nuevo" title="Nuevo"></a></h5><span>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="display" id="dataTables-example666">
                        ...
                        <tbody>
                          <?php 
							...
							$sql = " SELECT c.id, c.nombre, c.apellido, c.id_usuario, c.fecha_hora_alta, u.usuario FROM choferes c left join usuarios u on u.id = c.id_usuario WHERE 1 ";
