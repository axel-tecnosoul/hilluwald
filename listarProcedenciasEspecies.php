              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Procedencias Especies&nbsp;<a href="nuevoProcedenciasEspecies.php"><img src="img/icon_alta.png" width="24" height="25" border="0" alt="Nuevo" title="Nuevo"></a></h5><span>
                  </div>
                  <div class="card-body">
                        ...
                        <tbody><?php
                          ...
                          foreach ($pdo->query($sql) as $row) {?>
                            <tr>
                              ...
                              <td>
                                <a href="modificarProcedenciasEspecies.php?id=<?=$row["id"]?>"><img src="img/icon_modificar.png" width="24" height="25" border="0" alt="Modificar" title="Modificar"></a>
                                &nbsp;&nbsp;
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-footer">
			<a href="eliminarProcedenciasEspecies.php?id=<?php echo $row[0];?>" class="btn btn-primary">Eliminar</a>
			<a onclick="document.location.href='listarProcedenciasEspecies.php'" class="btn btn-light">Volver</a>
		  </div>
		</div>
	  </div>
	</div>
