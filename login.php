...
$submitted_username = ''; 
if(!empty($_POST)){ 
  $query = "SELECT id, usuario, clave, activo, id_perfil FROM usuarios WHERE activo = 1 and usuario = :user";
  ...
  if($login_ok){
    ...
    die("Redirecting to: listarClientes.php");
  }else{
            ...
            <div class="col-md-12">
              <div class="auth-innerright">
                <div class="authentication-box">
                  <div class="text-center"><img src="assets/images/logoLoginHilluwald.png" width="250px" alt=""></div>
                  <div class="card mt-4">
                    <div class="card-body">
