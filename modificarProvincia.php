                ...
                <div class="col-10">
                  <div class="page-header-left">
                    ...
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">Modificar Provincia</li>
                    </ol>
                  </div>
                </div>
                <!-- Bookmark Start-->
                ...
                <div class="card">
                  <div class="card-header">
                    <h5>Modificar provincia</h5>
				         ...
				         <form class="form theme-form" role="form" method="post" action="modificarProvincia.php?id=<?php echo $id?>">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                    ...
                    <div class="card-footer">
                      <div class="col-sm-9 offset-sm-3">
                        <button class="btn btn-primary" type="submit">Modificar</button>
						            <a onclick="document.location.href='listarProvincias.php'" class="btn btn-light">Volver</a>
                      </div>
                    </div>
                  </form>
                </div>
