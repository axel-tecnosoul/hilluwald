...
if ( !empty($_POST)) {
  ...
  $sql = "INSERT INTO productos(descripcion, precio, iva, activo, id_usuario_alta_modificacion) VALUES (?,?,?,1,?)";
  $q = $pdo->prepare($sql);
  $q->execute(array($_POST['descripcion'],$_POST['precio'],$_POST['iva'],$_SESSION["user"]["id"]));
